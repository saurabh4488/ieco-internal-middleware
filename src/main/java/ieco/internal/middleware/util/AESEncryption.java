...
public class AESEncryption {
    ...
    public static String encrypt(String text) throws NoSuchPaddingException, NoSuchAlgorithmException, IllegalBlockSizeException, BadPaddingException, InvalidAlgorithmParameterException, InvalidKeyException {
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        System.out.println(AESEncryption.encrypt(queryString)); //NOSONAR
    }
}
