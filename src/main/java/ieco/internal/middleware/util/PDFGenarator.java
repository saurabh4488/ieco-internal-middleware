...
public class PDFGenarator   {
	...
	/*public PDFGenarator(String name) {
		this.name = name;
	}*/
	...
	//@Override
	protected void buildPdfDocument(Map<String, String> model, Document doc, PdfWriter writer
	) throws Exception {
	...
	Font font_blue = FontFactory.getFont(FontFactory.TIMES_ROMAN, 13.0f, Font.BOLD);
	       ...
	       fontcurious_blue_bold.setColor(PciColors.CURIOUS_BLUE);
	            ...
	            //table_courses.setWidthPercentage(100);
	            ...
	            //Image image = Image.getInstance(Base64.getDecoder().decode(model.get("Photo")));
	            ...
	            //custImage.setWidthPercentage(10);
	            //custImage.scaleAbsolute(10f, 10f);
	            ...
	            //table_courses.addCell(custImage);
...
String getDate(String input) {
	...
	protected ByteArrayOutputStream createTemporaryOutputStream() {
	 ...
	 protected void prepareWriter(Map<String, String> model, PdfWriter writer)
